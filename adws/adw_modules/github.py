...
def get_github_env() -> Optional[dict]:
    ...
    # Inherit the full parent environment and only override the GitHub token.
    # A minimal env breaks `gh` on Windows: without SystemRoot (and friends) the
    # Go networking stack cannot resolve api.github.com and every call fails with
